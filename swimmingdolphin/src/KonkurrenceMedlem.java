...
public class KonkurrenceMedlem extends Medlem {
    ...
    KonkurrenceMedlem(String træner, String[] discipliner, ArrayList<Resultat> newList, String navn, LocalDate dato, String koen, String vejNavn, String email, String medlemstype, String aktivitetstype, ArrayList<LocalDate> betalingsHistorik) {
        super(navn, dato, koen, vejNavn, email, medlemstype, aktivitetstype, betalingsHistorik);
    }
